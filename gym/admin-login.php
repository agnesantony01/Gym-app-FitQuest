...
body {
    ...
    font-family: 'your-font-family', Arial, Helvetica, sans-serif; /* Add your preferred font-family */
}
...
.right {
    background: linear-gradient(212.38deg, rgba(242, 57, 127, 0.7) 0%, rgba(175, 70, 189, 0.71) 100%), url(OIP.jpg);
    color: #fff;
    position: relative;
